...
public class Addpatient extends AppCompatActivity {
    ...
    String url="http://192.168.1.15/sa2/mobile/addpatient.php";
    @Override
        ...
        StringRequest r=new StringRequest(Request.Method.POST, url,new Response.Listener<String>(){
            ...
            public void onResponse(String o) {
                try {
                    ...
                    if(res==true) {
                        Toast.makeText(Addpatient.this, "add patient successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Addpatient.this, "add patient Failed", Toast.LENGTH_SHORT).show();
